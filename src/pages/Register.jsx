...
const Register = () => {
  return (
    <div className="flex">
      ...
      <div className="w-full lg:w-1/2 lg:ml-[50%] mt-20 overflow-y-auto px-6 sm:px-16 py-6 text-center">
        ...
        <form className="form w-full space-y-6">
          ...
          <InputField
            type="submit"
            value="Next"
            className="bg-[#FF8D4C] hover:bg-[#CF550F] cursor-pointer text-lg text-white capitalize font-medium"
          />
        </form>
        <div className="flex flex-col mt-3 space-y-6">
          <p className="or flex items-center text-[#0A0075] font-medium cursor-pointer">
            <img
              src="../../public/images/blue.png"
